...
class Files {
    ...
    private static final LoggerFactory.Logger LOG = LoggerFactory.getLogger("Files");
        ...
        if (file.exists()) {
            ...
            if (!modified) {
                ...
                if (file.lastModified() < now) {
                    ...
                    LOG.warn("Last modified date " + new Date(file.lastModified()) + " is not set for file " + file.getAbsolutePath());
                }
            }
        }
    }
